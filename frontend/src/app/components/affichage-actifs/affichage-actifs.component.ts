...
@Component({
  selector: 'app-affichage-actifs',
  templateUrl: './affichage-actifs.component.html',
  styleUrls: ['./affichage-actifs.component.scss']
})
export class AffichageActifsComponent {
