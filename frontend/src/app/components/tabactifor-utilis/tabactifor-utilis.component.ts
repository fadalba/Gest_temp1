...
@Component({
  selector: 'app-tabactifor-utilis',
  templateUrl: './tabactifor-utilis.component.html',
  styleUrls: ['./tabactifor-utilis.component.scss']
})
export class TabactiforUtilisComponent {
