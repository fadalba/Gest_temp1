...
@Component({
  selector: 'app-affichage-archives',
  templateUrl: './affichage-archives.component.html',
  styleUrls: ['./affichage-archives.component.scss']
})
export class AffichageArchivesComponent {
