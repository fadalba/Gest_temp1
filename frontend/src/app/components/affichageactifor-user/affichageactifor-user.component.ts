...
@Component({
  selector: 'app-affichageactifor-user',
  templateUrl: './affichageactifor-user.component.html',
  styleUrls: ['./affichageactifor-user.component.scss']
})
export class AffichageactiforUserComponent {
